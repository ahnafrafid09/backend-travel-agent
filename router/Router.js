...
const LanguageRoute = require("./Language.js")
const SubCategoryRoute = require('./SubCategoryProduct.js')
const FacilityRoute = require('./Facility.js')
const UomRoute = require("./Uom.js")
const DestinationRoute = require("./Destination.js")
// const ProductRoute = require("./Product.js")
// const PriceRoute = require("./Price.js")
...
Route.use("/sub-category", SubCategoryRoute)
Route.use("/facility", FacilityRoute)
Route.use("/uom", UomRoute)
